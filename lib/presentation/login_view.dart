import 'package:ecommerce_app/mediaQuery/mediaquery_helper.dart';
import 'package:ecommerce_app/presentation/widgets/text_field_widget.dart';
        ...
        children: [
          Container(
            ...
            padding: EdgeInsets.symmetric(
                horizontal: 10,
                vertical: mediaQueryHelper.responsiveValue(context, 30)),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      shape: BoxShape.circle, color: Color(0xFFF9F5F4)),
                ...
                SizedBox(
                    height: mediaQueryHelper.responsiveHeight(context, 20)),
          ...
          Row(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                    color: Colors.grey,
                    fontSize: mediaQueryHelper.responsiveValue(context, 18)),
              ),
              ...
              Text(
                ...
                style: TextStyle(
                    color: Colors.black,
                    fontSize: mediaQueryHelper.responsiveValue(context, 20)),
              )
            ],
          )
        ],
